...
MSG_SOCKET_PATH = "/tmp/meshtastic_msg.sock"
POS_SOCKET_PATH = "/tmp/meshtastic_pos.sock"
...
pos_server = setup_unix_server(POS_SOCKET_PATH)
...
def on_receive(packet, interface):
    ...
    if isinstance(pos, dict):
        ...
        if lat is not None and lon is not None:
            ...
            pos_conn = try_send(pos_conn, line)
